...
class Food_Booking_user:
    def __init__(self):
        self.mydb=mc.connect(host="localhost",user="user_name",password="password",database="db_name")
...
def main():
    ...
    users = {"random_user_name": "password_in_int_type", '..........'}
    try:
       name = input("enter your name :")
       pass_ = int(input("enter the password : "))
    except ValueError as v:
        print(f"Error : {v}")
    if name == "admin_name" and pass_ == "password_in_int_type":
        admin()
    for key in users:
